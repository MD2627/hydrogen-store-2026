...
const PRODUCT_FAQ = [
  {
    ...
    answer: `
      <p>
        Crafting of your ring typically takes 50 business days, with expediting options available if you need it sooner.
        The exact completion date can be conveniently found on each product page.
        Please note that shipping is not included within this date and you can find all our
        <a href="/shipping" class="fancy">shipping information here</a>.
        For all timeframe information please visit our
        <a href="/crafting-timeframes" class="fancy">crafting timeframes page</a>.
      </p>
    `,
  },
  {
    ...
    answer: `
      <p>
        If you need help selecting from our range of diamond engagement rings or lab grown engagement rings,
        please <a href="/contact" class="fancy">contact us</a>.
        Our team, experienced in both lab created diamonds and moissanite, will assist you.
      </p>
    `,
  },
  {
    ...
    answer: `
      <p>
        Diamond Jewellery offers a <strong>Lifetime Manufacturing Warranty</strong> on all our rings,
        including engagement, wedding and fashion rings, giving you confidence and peace of mind with every purchase.
        For all other fine jewellery pieces, such as earrings, chains, pendants, bracelets and more,
        we provide a <strong>2-Year Manufacturer Warranty</strong>.
        <a href="/warranty" class="fancy" title="Diamond Jewellery Lifetime Warranty">
  ...
  },
  {
    ...
    answer: `
      <p>
        Yes! At Diamond Jewellery, we offer free international shipping on all orders,
        including those for the perfect diamond engagement ring.
        Shop online and add your chosen piece to your shopping bag with ease.
      </p>
      <p><strong>Import Duties and Taxes</strong></p>
      <p>
        Most of our orders are sent as DDP (Delivery Duty Paid – import duties & taxes are covered).
        However, there may be cases where you may have to pay local import taxes and duties,
        which Diamond Jewellery does not cover.
        For more details, please check our
        <a href="/shipping" class="fancy">Shipping</a> page
        or contact your local customs agency.
      </p>
    `,
  },
  {
    ...
    answer: `
      <p>
        Our showroom, featuring a range of lab grown diamond rings and moissanite pieces,
        is open <a href="/visit" class="fancy">by appointment only</a>.
  ...
  },
  {
    ...
    answer: `
      <p>
        ...
        <a href="/ring-size-guidance" class="fancy" title="Free Ring Sizer">
  ...
  },
  {
    ...
    answer: `
      <p>
        Absolutely! We understand that many of our products are purchased as surprise gifts
        for special occasions such as an engagement.
      </p>
      <p>F
        For this reason, we use subtle packaging that will not give away the contents of the package.
        Please let us know if we can help you in any other way to keep your purchase a surprise!
      </p>
    `,
  },
  {
    ...
    answer: `
      <p>
        At Diamond Jewellery, we accept payments via direct debit, cash (Melbourne only), or card.
        If you are looking for an extended payment plan,
        we also offer interest-free finance via Humm.
      </p>
    `,
  },
  {
    ...
    answer: `
      <p>
        At Diamond Jewellery, we value the craftsmanship involved in making each unique piece.
        Therefore, we do not offer refunds, returns or exchanges unless the item is faulty or damaged.
        Please see our <a href="/returns" class="fancy">Returns Policy</a> for more information.
      </p>
    `,
  },
  {
    ...
    answer: `
      <p>
        Absolutely! We offer <strong>One Free Resize</strong> for engagement and wedding rings
        within the first 12 months of completion
        (subject to eligible design style and metal type).
      </p>
      <p class="smallprint">
        There are certain resizing restrictions for each ring design.
        The specific information can be found on the product page.
        <a href="/free-resizing" class="fancy" title="Free Resizing">
