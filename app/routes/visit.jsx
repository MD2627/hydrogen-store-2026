...
export default function VisitShowroom() {
    ...
    const SERVICE_OPTIONS = [
        {
            ...
            description: 'Explore handcrafted engagement rings or work with our specialists to create a custom design tailored to your style.',
            duration: '45 MINUTES',
            image: 'https://cdn.shopify.com/s/files/1/0644/3067/0060/files/Engagement_Rings_service_400x400.jpg?v=1710000003'
        },
        {
            id: 'wedding',
            title: 'Wedding Band Appointment',
            description: 'Discover timeless wedding bands crafted for comfort, elegance, and everyday wear.',
            duration: '30 MINUTES',
            image: 'https://cdn.shopify.com/s/files/1/0644/3067/0060/files/Wedding_Bands_service_400x400.jpg?v=1710000004'
        },
        {
            id: 'fine-jewellery',
            title: 'Fine Jewellery Consultation',
            description: 'Browse our curated collection of fine jewellery including earrings, necklaces, bracelets, and meaningful gifts.',
            duration: '30 MINUTES',
            image: 'https://cdn.shopify.com/s/files/1/0644/3067/0060/files/Fine_Jewellery_service_400x400.jpg?v=1710000005'
        }
    ];
    ...
    const SHOWROOM_IMAGES = {
        ...
        'auckland': 'https://cdn.shopify.com/s/files/1/0610/2194/5934/files/07f79a4d805e075c3d3b57305d30e0f5.jpg?v=1777963281',
        'london': 'https://cdn.shopify.com/s/files/1/0610/2194/5934/files/f25a49c91df039493ed6e1491224e864.jpg?v=1777963280',
        'san-francisco': 'https://cdn.shopify.com/s/files/1/0610/2194/5934/files/6db1937cd1f8f81fb2415b8670bceaad.jpg?v=1777963280',
    ...
    const LOCATION_OPTIONS = [
        {
            ...
            duration: '45 MINUTES',
            image: 'https://cdn.shopify.com/s/files/1/0610/2194/5934/files/6db1937cd1f8f81fb2415b8670bceaad.jpg?v=1777963280'
        },
        {
            id: 'quick-chat',
            city: 'Quick Chat',
        ...
        <div className="visit-page">
                                ...
                                <div className="datetime-selection">
                                    ...
                                    {bookingDate && (
                                        <div className="time-slots-section">
                                            <p className="timezone-disclaimer ff-c f-12 text-center">Available appointment times displayed in <strong>Indian Standard Time (IST)</strong></p>
            ...
            <section className="limit-width-banner">
                {BANNER ? (
                    ...
                    <img
                        src="https://cdn.shopify.com/s/files/1/0610/2194/5934/files/6db1937cd1f8f81fb2415b8670bceaad.jpg?v=1777963280"
