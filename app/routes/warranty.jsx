                ...
                <div className="page-width">
                    <div className='warranty-editorial'>
                        <p className="sb-description">
                            ...
                            for a lifetime. Every piece we craft undergoes rigorous quality control testing to ensure
                            it meets our boutique standards.
                        </p>
                    </div>
                </div>
            </section>
